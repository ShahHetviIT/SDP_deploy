...
// export default function Sessional2({
//   studentContacts,
//   teacherLecture,
//   teacherLab,
// }) {
...
//             updatedTotal.totalMarks[lecture] = totalExamMarks[lecture][0] || "";
//           }
//           if (totalAttendanceLecture.hasOwnProperty(lecture)) {
//             updatedTotal.totalAttendance[lecture] =
//               totalAttendanceLecture[lecture][0] || "";
//           }
//         });
...
//             updatedTotal.totalAttendance[lab] =
//               totalAttendanceLab[lab][0] || "";
//           }
//         });
...
//     try {
//       const result = await axios.post(marksAttendanceRoute, { marks, total });
...
//           </tr>
//           <tr>
//             {teacherLecture && teacherLecture.map((lecture, index) => (
...
//               </React.Fragment>
//             ))}
//             {teacherLab && teacherLab.map((lab, index) => (
//               <th key={index}>
//                 {lab}
//                 <br />
//                 (Attendance)
...
//               {teacherLecture && teacherLecture.map((lecture, lectureIndex) => (
...
//                 </React.Fragment>
//               ))}
//               {teacherLab && teacherLab.map((lab, labIndex) => (
//                 <td key={labIndex}>
//                   <input
//                     type="number"
//                     placeholder="-"
...
//               <React.Fragment key={lectureIndex}>
//                 <th>
//                   {/* Input field for the total marks */}
//                   <input
//                     type="number"
//                     placeholder="-"
//                     className="inp"
//                     value={total.totalMarks[lecture] || ""}
//                     onChange={(e) =>
//                       handleTotalChange(lecture, "totalMarks", e.target.value)
//                     }
//                   />
//                 </th>
//                 <th>
//                   {/* Input field for the total attendance */}
//                   <input
//                     type="number"
//                     placeholder="-"
//                     className="inp"
//                     value={total.totalAttendance[lecture] || ""}
//                     onChange={(e) =>
//                       handleTotalChange(
//                         lecture,
//                         "totalAttendance",
...
//                     placeholder="-"
//                     className="inp"
//                     value={total.totalAttendance[lab] || ""}
//                     onChange={(e) =>
//                       handleTotalChange(lab, "totalAttendance", e.target.value)
//                     }
//                   />
//                 </th>
//               </React.Fragment>
